"""This module was taken from https://github.com/ietf-tools/rfc2html"""
...
def markup(text, path=".", script="", extra="", name=None):
    ...
    ref_beg = re.search(
        r"(?im)^(\d+(\.\d+)*)(\.?[ ]+)(References?|Normative References?|Informative References?)",
        text,
    )
    ref_text = text[ref_beg.end() :] if ref_beg else text

    ref_stop_list = re.findall(
        r"(?im)^(?:Appendix\s+[A-Z]\.|[0-9]+\.)(?:[0-9.]+)?\s+\S.+$", ref_text
    )
    ...
    for tuple in ref_defs:
        ...
        if title_match:
            ...
            reference[tuple[1]] = (
                reftitle
                if not re.search(r"(?i)(page|section|appendix)[- ]", reftitle)
                else ""
            )
    ...
    def rfclist_replace(keyword, text):
        def replacement(match):
            ...
            group[3] = re.sub(
                r"\d+",
                r'<a href="%s?%srfc=\g<0>">\g<0></a>' % (script, extra),
                group[3],
            )
            if group[8]:
                group[8] = re.sub(
    ...
    # title markup
    head = re.sub(
        r"(?im)(([12][0-9][0-9][0-9]|^Obsoletes.*|^Category: (Standards Track|Informational|Experimental|Best Current Practice)) *\n\n+ +)([A-Z][^\n]+)$",
        r"\g<1><h1>\g<4></h1>",
        head,
        1,
    )
    ...
    text = re.sub(
        r'(?im)(\s|^|[^=]"|\()((http|https|ftp)://([:A-Za-z0-9_./@%&?#~=-]+)?)(\n +)([A-Za-z0-9_./@%&?#~=-]+[./][A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])([.,)"\s]|$)',
        r'\g<1><a href="\g<2>\g<6>">\g<2></a>\g<5><a href="\g<2>\g<6>">\g<6></a>\g<7>',
        text,
    )
    text = re.sub(
        r"(?im)(&lt;)((http|https|ftp)://([:A-Za-z0-9_./@%&?#~=-]+)?)(\n +)([A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])(&gt;)",
        r'\g<1><a href="\g<2>\g<6>">\g<2></a>\g<5><a href="\g<2>\g<6>">\g<6></a>\g<7>',
        text,
    )
    ...
    text = re.sub(
        r"(?im)<((http|https|ftp)://([:A-Za-z0-9_./@%&?#~=-]+)?)(\n +)([A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])>",
        r'<\g<1><a href="\g<1>\g<5>">\g<1></a>\g<4><a href="\g<1>\g<5>">\g<5></a>>',
        text,
    )
    text = re.sub(
        r"(?im)(&lt;)((http|https|ftp)://([:A-Za-z0-9_./@%&?#~=-]+)?)(\n +)([A-Za-z0-9_./@%&;?#~=-]+[A-Za-z0-9_/@%&;?#~=-])(&gt;)",
    ...
    text = re.sub(
        r"(?im)<((http|https|ftp)://([:A-Za-z0-9_./@%&?#~=-]+)?)(\n +)([A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])(\n +)([A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])>",
        r'<\g<1><a href="\g<1>\g<5>\g<7>">\g<1></a>\g<4><a href="\g<1>\g<5>\g<7>">\g<5></a>\g<6><a href="\g<1>\g<5>\g<7>">\g<7></a>>',
        text,
    )
    text = re.sub(
        r"(?im)(&lt;)((http|https|ftp)://([:A-Za-z0-9_./@%&?#~=-]+)?)(\n +)([A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])(\n +)([A-Za-z0-9_./@%&;?#~=-]+[A-Za-z0-9_/@%&;?#~=-])(&gt;)",
        r'\g<1><a href="\g<2>\g<6>\g<8>">\g<2></a>\g<5><a href="\g<2>\g<6>\g<8>">\g<6></a>\g<7><a href="\g<2>\g<6>\g<8>">\g<8></a>\g<9>',
        text,
    )
    # link on a single line
    text = re.sub(
        r'(?im)(\s|^|[^=]"|&lt;|\()((http|https|ftp)://[:A-Za-z0-9_./@%&?#~=-]+[A-Za-z0-9_/@%&?#~=-])([.,)"\s]|&gt;|$)',
        r'\g<1><a href="\g<2>">\g<2></a>\g<4>',
        text,
    )
    ...
    text = re.sub(
        r'(?i)<a href="[a-z]*?://([a-z0-9_-]+?\.)?example(\.(com|org|net))?(/.*?)?">(.*?)</a>',
        r"\g<5>",
        text,
    )
    ...
    text = re.sub(
        r"([^/#=\?\w-])(draft-([-a-zA-Z0-9]+-)?)((?: {3,}\S.*)?\n +)([-a-zA-Z0-9]+[a-zA-Z0-9](.txt)?)",
        r'\g<1><a href="%s?%sdraft=\g<2>\g<5>">\g<2></a>\g<4><a href="%s?%sdraft=\g<2>\g<5>">\g<5></a>'
        % (script, extra, script, extra),
        text,
    )
    # draft name on one line (but don't mess with what we just did above)
    text = re.sub(
        r"([^/#=\?\w>=-])(draft-[-a-zA-Z0-9]+[a-zA-Z0-9](.txt)?)",
        r'\g<1><a href="%s?%sdraft=\g<2>">\g<2></a>' % (script, extra),
        text,
    )
    ...
    text = re.sub(
        r"(?i)([^[/>\w-])(rfc([- ]?))([0-9]+)(\W)",
        r'\g<1><a href="%s?%srfc=\g<4>">\g<2>\g<4></a>\g<5>' % (script, extra),
        text,
    )
    # rfc and number on separate lines
    text = re.sub(
        r"(?i)([^[/>\w-])(rfc([-]?))(\n +)([0-9]+)(\W)",
        r'\g<1><a href="%s?%srfc=\g<5>">\g<2></a>\g<4><a href="%s?%srfc=\g<5>">\g<5></a>\g<6>'
        % (script, extra, script, extra),
        text,
    )
    # spelled out Request For Comments markup
    text = re.sub(
        r"(?i)(\s)(Request\s+For\s+Comments\s+\([^)]+\)\s+)([0-9]+)",
        r'\g<1>\g<2><a href="%s?%srfc=\g<3>">\g<3></a>' % (script, extra),
        text,
    )
    # bcp markup
    text = re.sub(
        r"(?i)([^[/>\w.-])(bcp([- ]?))([0-9]+)(\W)",
        r'\g<1><a href="%s?%sbcp=\g<4>">\g<2>\g<4></a>\g<5>' % (script, extra),
        text,
    )
    text = re.sub(
        r"(?i)([^[/>\w.-])(bcp([-]?))(\n +)([0-9]+)(\W)",
        r'\g<1><a href="%s?%sbcp=\g<5>">\g<2></a>\g<4><a href="%s?%sbcp=\g<5>">\g<5></a>\g<6>'
        % (script, extra, script, extra),
        text,
    )
    ...
    def workinprogress_replacement(match):
        ...
        g5 = match.group(5)
        return (
            '%s[<a id="ref-%s">%s</a>]%s<a style="text-decoration: none" href="https://www.google.com/search?sitesearch=datatracker.ietf.org%%2Fdoc%%2Fhtml%%2F&amp;q=inurl:draft-+%s">%s</a>%s'
            % (g1, g2, g2, g3, g4url, g4, g5)
        )
    ...
    text = re.sub(
        r"(\W)(\[)(RFC [0-9]+)((, ?RFC [0-9]+)*\])", reference_replacement, text
    )
    while True:
        old = text
        text = re.sub(
    ...
    text = re.sub(
        r"(?m)^(\s*)(\d+(\.\d+)*)(\.?[ ]+)(.*[^ .])( *\. ?\.)(.*[0-9])$",
        r'\g<1><a href="#section-\g<2>">\g<2></a>\g<4>\g<5>\g<6>\g<7>',
        text,
    )
    text = re.sub(
        r"(?m)^(\s*)(Appendix |)([A-Z](\.\d+)*)(\.?[ ]+)(.*[^ .])( *\. ?\.)(.*[0-9])$",
        r'\g<1><a href="#appendix-\g<3>">\g<2>\g<3></a>\g<5>\g<6>\g<7>\g<8>',
        text,
    )
    ...
    if re.search(multidoc_separator, text):
        ...
        for i in range(len(parts)):
            parts[i] = re.sub(
                r"(?si)(\f)([^\f]*\[Page (\w+)\])",
                r'\g<1><span id="%(page)s-\g<3>" ></span>\g<2>'
                % {"page": "page-%s" % (i + 1)},
                parts[i],
            )
            parts[i] = re.sub(
                r"(?i)(\. ?\. +|\. \. \.|\.\.\. *)([0-9ivxlc]+)( *\n)",
                r'\g<1><a href="#%(page)s-\g<2>">\g<2></a>\g<3>'
                % {"page": "page-%s" % (i + 1)},
                parts[i],
            )
        ...
        text = re.sub(
            r"(?si)(\f)([^\f]*\[Page (\w+)\])",
            r'\g<1><hr class="noprint" id="page-\g<3>">\g<2>',
            text,
        )
        # contents link markup: page numbers
        text = re.sub(
            r"(?i)(\. ?\. +|\. \. \.|\.\.\. *)([0-9ivxlc]+)( *\n)",
            r'\g<1><a href="#page-\g<2>">\g<2></a>\g<3>',
            text,
        )
    ...
    def section_anchor_replacement(match):
        ...
        level = min(level, 6)
        html = (
            '<h%s><a class="selflink" id="section-%s" href="#section-%s">%s</a>%s</h%s>'
            % (
                level,
                match.group(1),
                match.group(1),
    ...
    text = re.sub(
        r"(?i)(section\s)(\d+(\.\d+)*)",
        r'<a href="#section-\g<2>">\g<1>\g<2></a>',
        text,
    )
    text = re.sub(
        r"(?i)(section)\n(\s+)(\d+(\.\d+)*)",
        r'<a href="#section-\g<3>">\g<1></a>\n\g<2><a href="#section-\g<3>">\g<3></a>',
        text,
    )
    ...
    while True:
        old = text
        text = re.sub(
            r"(?i)(sections\s(<a.*?>.*?</a>(,\s|\s?-\s?|\sthrough\s|\sor\s|\sto\s|,?\sand\s))*)(\d+(\.\d+)*)",
            r'\g<1><a href="#section-\g<4>">\g<4></a>',
            text,
        )
        if text == old:
            break
    ...
    def appendix_replacement(match):
        ...
        level = min(level, 6)
        return (
            '<h%s><a class="selflink" id="appendix-%s" href="#appendix-%s">%s%s</a>%s</h%s>'
            % (level, num, num, match.group(1), num, txt, level)
        )

    text = re.sub(
        r"(?m)^(Appendix |)([A-Z](\.|\.\d+)+)(\.?[ ].*)$", appendix_replacement, text
    )
    # text = re.sub("(?i)(\n *\n *)(\d+(\.\d+)*)(\.?[ ].*)", appendix_replacement, text)
    # appendix number link markup
    text = re.sub(
        r" ([Aa]ppendix\s)([A-Z](\.\d+)*)",
        r' <a href="#appendix-\g<2>">\g<1>\g<2></a>',
        text,
    )
    text = re.sub(
        r" ([Aa]ppendix)\n(\s+)([A-Z](\.\d+)*)",
        r' <a href="#appendix-\g<3>">\g<1></a>\n\g<2><a href="#appendix-\g<3>">\g<3></a>',
        text,
    )
    ...
    for n in ["rfc", "bcp", "fyi", "std"]:
        ...
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(section)\s(\d+(\.\d+)*)</a>(\.?\s+(of|in)\s+)<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>'
            % n,
            r'<a href="%s?%s%s=\g<9>\g<1>">\g<2>&nbsp;\g<3>\g<5>\g<8>\g<9></a>'
            % (script, extra, n),
            text,
        )
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(section)</a>(\n\s+)<a href="(?:[^"]*)"[^>]*>(\d+(\.\d+)*)</a>(\.?\s+(of|in)\s+)<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>'
            % n,
            r'<a href="%s?%s%s=\g<10>\g<1>">\g<2></a>\g<3><a href="%s?%s%s=\g<10>\g<1>">\g<4>\g<6>\g<9>\g<10></a>'
            % (script, extra, n, script, extra, n),
            text,
        )
        # appendix x of rfc y markup
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(appendix)\s([A-Z](\.\d+)*)</a>(\.?\s+(of|in)\s+)<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>'
            % n,
            r'<a href="%s?%s%s=\g<9>\g<1>">\g<2>&nbsp;\g<3>\g<5>\g<8>\g<9></a>'
            % (script, extra, n),
            text,
        ...
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(appendix)</a>(\n\s+)<a href="(?:[^"]*)"[^>]*>([A-Z]+(\.\d+)*)</a>(\.?\s+(of|in)\s+)<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>'
            % n,
            r'<a href="%s?%s%s=\g<10>\g<1>">\g<2></a>\g<3><a href="%s?%s%s=\g<10>\g<1>">\g<4>\g<6>\g<9>\g<10></a>'
            % (script, extra, n, script, extra, n),
            text,
        ...
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>(,?\s+)<a href="([^"]*)"[^>]*>(section)\s?(([^<]*))</a>'
            % n,
            r'<a href="%s?%s%s=\g<3>\g<5>">\g<2>\g<3>\g<4>\g<6>&nbsp;\g<7></a>'
            % (script, extra, n),
            text,
        )
        # rfc y, appendix x markup
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>(,?\s+)<a href="([^"]*)"[^>]*>(appendix)\s?(([^<]*))</a>'
            % n,
            r'<a href="%s?%s%s=\g<3>\g<5>">\g<2>\g<3>\g<4>\g<6>&nbsp;\g<7></a>'
            % (script, extra, n),
            text,
        ...
        # section x of? [rfc y] markup
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(section)\s(\d+(\.\d+)*)</a>(\.?\s+(of\s+|in\s+)?)\[<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>\]'
            % n,
            r'<a href="%s?%s%s=\g<9>\g<1>">\g<2>&nbsp;\g<3>\g<5>[\g<8>\g<9>]</a>'
            % (script, extra, n),
            text,
        ...
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(section)</a>(\n\s+)<a href="(?:[^"]*)"[^>]*>(\d+(\.\d+)*)</a>(\.?\s+(of\s+|in\s+)?)\[<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>\]'
            % n,
            r'<a href="%s?%s%s=\g<10>\g<1>">\g<2></a>\g<3><a href="%s?%s%s=\g<10>\g<1>">\g<4>\g<6>[\g<9>\g<10>]</a>'
            % (script, extra, n, script, extra, n),
            text,
        ...
        # appendix x of? [rfc y] markup
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(appendix)\s([A-Z](\.\d+)*)</a>(\.?\s+(of\s+|in\s+)?)\[<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>\]'
            % n,
            r'<a href="%s?%s%s=\g<9>\g<1>">\g<2>&nbsp;\g<3>\g<5>[\g<8>\g<9>]</a>'
            % (script, extra, n),
            text,
        ...
        text = re.sub(
            r'(?i)<a href="([^"]*)"[^>]*>(appendix)</a>(\n\s+)<a href="(?:[^"]*)"[^>]*>([A-Z](\.\d+)*)</a>(\.?\s+(of\s+|in\s+)?)\[<a href="([^"]*)"[^>]*>(%s[- ]?)([0-9]+)</a>\]'
            % n,
            r'<a href="%s?%s%s=\g<10>\g<1>">\g<2></a>\g<3><a href="%s?%s%s=\g<10>\g<1>">\g<4>\g<6>[\g<9>\g<10>]</a>'
            % (script, extra, n, script, extra, n),
            text,
        ...
        # [rfc y], section x markup
        text = re.sub(
            r'(?i)\[<a href="([^>"]+)"[^>]*>(%s[- ]?)([0-9]+)</a>\](,?\s+)<a href="([^>"]*)"[^>]*>(section)\s(\d+(\.\d+)*)</a>'
            % n,
            r'<a href="%s?%s%s=\g<3>\g<5>">[\g<2>\g<3>]\g<4>\g<6>&nbsp;\g<7></a>'
            % (script, extra, n),
            text,
        ...
        # [rfc y], appendix x markup
        text = re.sub(
            r'(?i)\[<a href="([^>"]+)"[^>]*>(%s[- ]?)([0-9]+)</a>\](,?\s+)<a href="([^>"]*)"[^>]*>(appendix)\s([A-Z](\.\d+)*)</a>'
            % n,
            r'<a href="%s?%s%s=\g<3>\g<5>">[\g<2>\g<3>]\g<4>\g<6>&nbsp;\g<7></a>'
            % (script, extra, n),
            text,
    ...
    old = text
    text = re.sub(
        r'(?i)<a href="[^"]*"[^>]*>(section\s)(\d+(\.\d+)*)</a>(\.?[a-z]*\s+(of|in)\s+)(\[?)<a href="([^"]*)"([^>]*)>(.*)</a>(\]?)',
        r'\g<1>\g<2>\g<4>\g<6><a href="\g<7>"\g<8>>\g<9></a>\g<10>',
        text,
    )
    text = re.sub(
        r'(?i)(\[?)<a href="([^"]*#ref[^"]*)"([^>]*)>(.*?)</a>(\]?,\s+)<a href="[^"]*"[^>]*>(section\s)(\d+(\.\d+)*)</a>',
        r'\g<1><a href="\g<2>"\g<3>>\g<4></a>\g<5>\g<6>\g<7>',
        text,
    )
    ...
    # boilerplate text:
    text = re.sub(
        r'(?i)<a href="[^"]*"[^>]*>(section\s)(\d+(\.\d+)*)</a>(\.?[a-z]*\s+(of|in)\s*\n\s*the Trust Legal Provisions)',
        r"\g<1>\g<2>\g<4>",
        text,
    )
