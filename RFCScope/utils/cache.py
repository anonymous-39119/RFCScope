    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                func_str = str(
                    func
                )  # this cache will likely be invalidated after a restart
            ...
            filtered_args = [
                arg for i, arg in enumerate(args) if param_names[i] not in skip_list
            ]
            ...
            hash_str = hashlib.sha256(
                str((func_str, args_str, kwargs_str, cache_keys_str)).encode()
            ).hexdigest()
